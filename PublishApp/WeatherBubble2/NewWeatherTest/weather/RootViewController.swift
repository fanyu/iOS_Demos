...
class RootViewController: UIViewController,CLLocationManagerDelegate, MFMailComposeViewControllerDelegate {
    ...
    var pageTemp: String?
    var pageHumidity: String?
    var pageCondition: String?
    var pageWind: String?
    var pagePollution: String?
    var pageSunRise: String?
    var pageSunSet: String?
    var pageCountryName: String?
    var pageCityID: String?
